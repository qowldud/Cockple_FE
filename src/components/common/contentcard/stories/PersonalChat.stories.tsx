...
import ProfileImage from "../../../../assets/images/Profile_Image.png"; // 예시로 Profile_Image 사용
...
// 읽지 않은 메시지가 있는 상태의 PersonalChat 스토리
...
// 마지막 메시지가 긴 상태의 PersonalChat 스토리
export const LongMessage: Story = {
  args: {
    ...Default.args,
    lastMessage: "안녕하세요! 오랜만에 다 같이 모여서 즐거운 시간 보낼 수 있으면 좋겠습니다. 다들 시간 괜찮으신가요? 이번 주말에 다 같이 모여서 운동 한 번 할까요? 의견 남겨주세요!",
    unreadCount: 1,
  },
};
