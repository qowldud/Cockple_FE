...
interface GR600MProps {
  initialStatus?: BtnStatus;
  label?: string;
}

const GR600_S = ({ initialStatus = "default", label = "Btn" }: GR600MProps) => {
  ...
  const statusStyle = {
    ...
    default: "bg-white border border-gr-600 text-gr-600",
    pressing: "bg-gr-600 text-white",
    clicked: "bg-white border border-gr-600 text-gr-600",
  };
